...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const legal = getBusinessSiteLegalCopy("de", "datenschutz", site);
  return {
...
export default async function SiteDatenschutzPage() {
  const site = await fetchPublicBusinessSite(getSiteCompanySlug());
  return <BusinessSiteLegalPage site={site} variant="datenschutz" />;
}
